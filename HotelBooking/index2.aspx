<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index2.aspx.cs" Inherits="HotelBooking.index2" %>
                                    ...
                                    <div class="main-menu  d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">
                                                ...
                                                <li><a href="user/CustomerLogIn.aspx">Log In</a></li>
                                                <li><a href="user/Booking.aspx">rooms</a></li>
                                                <li><a href="about.html">About</a></li>
                                                <li><a href="contact.aspx">Contact</a></li>
                                                <li><a href="user/UserBookingList.aspx">Booking List</a></li>
                                ...
                                <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                                    <div class="book_room">
                                        ...
                                        <div class="book_btn d-none d-lg-block">
                                            ...
                                            <a href="user/Booking.aspx">Book Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                ...
                <div class="footer_top">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 col-lg-3">
                                <div class="footer_widget">
                                    <h3 class="footer_title">Reservation
                                    </h3>
                                    <p class="footer_text">
                                        +10 367 267 2678
                                <br>
